...
//		Random random = new Random();
//		return String.format("<%d-%d>", random.nextInt(1000), random.nextInt(1000));
//	}
//
...
//		Random random = new Random();
//		return String.format("{%d,}", random.nextInt(1000));
//	}
//
...
//	}
//
//	public static String makeZeroOrMore(String r) {
//		return r + "*";
//	}
//
//	public static String makeOneOrMore(String r) {
//		return r + "+";
//	}
//
//	public static String makeZeroOrOne(String r) {
//		return r + "?";
//	}
//
//	public static String makeExclude(String r) {
//		return "~" + r;
//	}
//
//	public static String makeClass(String r) {
//		return "[" + r + "]";
//	}
//
//	public static String makeExcludeClass(String r) {
//		return "[^" + r + "]";
//	}
//
//	public static String makeAnyChar(String r) {
//		return r + ".";
//	}
//
//	public static String makeNothing(String r) {
//		return r + "#";
//	}
//
//	public static String makeAny(String r) {
//		return r + "@";
//	}
//
//	public static String makeGroup(String r) {
//		return "(" + r + ")";
//	}
